...
const Schedule: React.FC = () => {
    ...
    const monthSchedule = scheduleItems.filter(item => item.date.startsWith('2025-01'));

    const upcomingEvents = [
        { id: 1, title: 'Midterm Exams', date: '2025-01-22', type: 'exam' },
        { id: 2, title: 'Project Submission Deadline', date: '2025-01-25', type: 'deadline' },
        { id: 3, title: 'Guest Lecture: AI in Education', date: '2025-01-28', type: 'special' }
    ];
    ...
    const todaySchedule = scheduleItems.filter(item => item.date === '2025-01-15');
    const tomorrowSchedule = scheduleItems.filter(item => item.date === '2025-01-16');
                    ...
                    {viewMode === 'week' ? (
                        ...
                        <>
                            ...
                            <div className="bg-white rounded-xl shadow-sm border border-gray-100">
                                <div className="p-6 border-b border-gray-100">
                                    <div className="flex items-center justify-between">
                                        <h2 className="text-xl font-semibold text-gray-900">This Month's Classes</h2>
                                        <div className="flex items-center space-x-2 text-sm text-gray-500">
                                            <Calendar className="h-4 w-4" />
